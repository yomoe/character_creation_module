...
class Character:
    ...
    def attack(self):
        value_attack = DEFAULT_ATTACK + random.randint(
            *self.RANGE_VALUE_ATTACK)
        return (f'{self.name} нанёс противнику урон, равный {value_attack}')

    def defend(self):
        value_defence = DEFAULT_DEFENCE + random.randint(
...
def start_training(character):
    ...
    # print(f'{character.name}, ты {COMMANDS[character.__class__]}')
