...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        return f'{char_name} нанёс урон противнику равный ' \
               f'{5 + random.randint(3, 5)}'
    if char_class == 'mage':
        return f'{char_name} нанёс урон противнику равный ' \
               f'{5 + random.randint(5, 10)}'
    if char_class == 'healer':
        return f'{char_name} нанёс урон противнику равный ' \
               f'{5 + random.randint(-3, -1)}'


def defence(char_name: str, char_class: str) -> str:
    """Give a defence."""
    if char_class == 'warrior':
        return f'{char_name} блокировал {10 + random.randint(5, 10)} урона'
    if char_class == 'mage':
        return f'{char_name} блокировал {10 + random.randint(-2, 2)} урона'
    if char_class == 'healer':
        return f'{char_name} блокировал {10 + random.randint(2, 5)} урона'
